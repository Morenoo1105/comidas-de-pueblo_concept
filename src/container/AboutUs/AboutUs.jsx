...
const AboutUs = () => (
  ...
  >
    <div className="app__aboutus-overlay flex__center">
      <img src={images.G} alt="ComidasDePueblo" />
    </div>

    <div className="app__aboutus-content flex__center">
      <div className="app__aboutus-content_about">
        <h1 className="headtext__cormorant">Sobre nosotros</h1>
        <img src={images.spoon} alt="little spoon" className="spoon__img" />
        <p className="p__opensans">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Non nam
          explicabo cumque, error dolores velit accusantium aperiam veniam
          architecto.
        </p>
